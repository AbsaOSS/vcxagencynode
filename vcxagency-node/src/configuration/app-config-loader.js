...
function buildAppConfigFromEnvVariables () {
  const appConfig = {
    ...
    MYSQL_WALLET_HOST: process.env.MYSQL_WALLET_HOST,
    MYSQL_WALLET_PORT: process.env.MYSQL_WALLET_PORT,
    MYSQL_WALLET_DBNAME: process.env.MYSQL_WALLET_DBNAME,
    MYSQL_WALLET_CONNECTION_LIMIT: process.env.MYSQL_WALLET_CONNECTION_LIMIT,

    MYSQL_WALLET_ACCOUNT: process.env.MYSQL_WALLET_ACCOUNT,
    MYSQL_WALLET_PASSWORD_SECRET: process.env.MYSQL_WALLET_PASSWORD_SECRET,
